...
class BaseModelArguments:
    ...
    llm_name_or_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the LLM model weight or identifier from huggingface.co/models or modelscope.cn/models. This is used for the custom llava model."},
    )
    processor_name_or_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the processor weight or identifier from huggingface.co/models or modelscope.cn/models. This is used for the custom llava model."},
    )
    vision_tower: Optional[str] = field(
        default=None,
        metadata={"help": "The vision tower to use for multimodal models."},
    )
    vision_model_name: Optional[str] = field(
        default="gigapath",
        metadata={"help": "The vision model architecture name (e.g., gigapath, conch, uni)."},
    )
    vision_mode: Optional[str] = field(
        default="wsi",
        metadata={"help": "The vision mode: 'roi' for ROI models, 'wsi' for WSI models."},
    )
    mm_vision_select_layer: Optional[int] = field(
        default=-1,
        metadata={"help": "The layer to select from the vision tower."},
    )
    ...
    image_token_id: Optional[int] = field(
        default=None,
        metadata={"help": "The token ID to use for images."},
    )
    image_seq_length: int = field(
        default=2048,
        metadata={"help": "The sequence length for image tokens."},
    )
    # Custom LLaVA model parameters
    mm_hidden_size: Optional[int] = field(
        default=768,
        metadata={"help": "Hidden size for the multimodal projector."},
    )
    mm_projector_type: Optional[str] = field(
        default="linear",
        metadata={"help": "Type of the multimodal projector."},
    )
    projector_dropout: float = field(
        default=0.1,
        metadata={"help": "Dropout ratio for the multimodal projector."},
    )
    gamma_init: float = field(
        default=2.0,
        metadata={"help": "Initial value for the gamma parameter in the projector."},
    )
    gamma_min: float = field(
        default=0.8,
        metadata={"help": "The minimum value of the gamma parameter in the projector."}
    )
    gamma_max: float = field(
        default=2.0,
        metadata={"help": "The maximum value of the gamma parameter in the projector."}
    )
    ...
    mm_vision_select_feature: Optional[str] = field(
        default="patch",
        metadata={"help": "Which feature to select from vision tower."},
    )
    vision_feature_select_mode: Literal["prumerge", "random_sample", "prompt_topk", "none"] = field(
        default="prumerge",
        metadata={"help": "The mode to select/process vision features before the projector."},
    )
    image_aspect_ratio: Optional[str] = field(
        default="square",
        metadata={"help": "Aspect ratio for image processing."},
    )
...
class ModelArguments(
    ...
    image_seq_length: Optional[int] = field(
        default=None,
        metadata={"help": "The sequence length of images after processing, used for asserting shapes."},
    )
    projector_path: Optional[str] = field(
        default=None,
        metadata={"help": "Path to the pretrained projector weights to load."},
    )

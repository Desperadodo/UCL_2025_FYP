...
class DataArguments:
    ...
    patches_per_wsi: int = field(
        default=2048,
        metadata={"help": "Max number of patch features to load from each WSI."},
    )
    ...
    use_prefix_lm_mask: bool = field(
        default=False,
        metadata={"help": "Whether to use the custom Prefix-LM attention mask."},
    )
    filter_by_data_source: Optional[str] = field(
        default=None,
        metadata={"help": "Filter the dataset by the 'data_source' column."},
    )

...
def try_download_model_from_other_hub(model_args: "ModelArguments",model_name_or_path: str = None, custom: bool = False) -> str:
    if model_name_or_path:
        model_name_or_path = model_name_or_path
    else:
        model_name_or_path = model_args.model_name_or_path
    if (not use_modelscope() and not use_openmind()) or os.path.exists(model_name_or_path) or custom:
